...
from .models import Enrollments, CourseActivity, CourseActivityMaterial
...
def course_activity_notification(sender, instance, created, **kwargs):
    if created:
        ...
        for student_id in student_ids:
            send_new_activity_notification.delay(student_id, instance.course, instance.activity_title)